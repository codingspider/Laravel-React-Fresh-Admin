...
namespace Modules\KOT\Http\Controllers;

use App\Http\Controllers\Controller;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;
use Modules\KOT\Services\KOTService;

class KOTController extends Controller
{
    protected string $langKey = 'kot::module';

    public function __construct(protected KOTService $service) {}
