...
class WebsiteSettingController extends Controller
{
    ...
    public function update(Request $request): JsonResponse
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'comparison_platform_label' => 'nullable|string|max:255',
            'comparison_others_label' => 'nullable|string|max:255',
            'comparison_rows' => 'nullable|array',
            'comparison_rows.*.feature' => 'required|string|max:500',
            'comparison_rows.*.us' => 'nullable|string|max:255',
            'comparison_rows.*.competitors' => 'nullable|string|max:255',
