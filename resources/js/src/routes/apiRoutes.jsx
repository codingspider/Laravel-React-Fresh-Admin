...
export const GET_NOTIFICATION_SETTING_V1 = '/v1/notification/settings';
export const UPDATE_NOTIFICATION_SETTING_V1 = '/v1/notification/settings';
export const TEST_SMS_V1 = '/v1/notification/test-send';
export const TEST_EMAIL_V1 = '/v1/notification/test-email';
export const LIST_SMS_TEMPLATES_V1 = '/v1/sms-templates';
export const STORE_SMS_TEMPLATE_V1 = '/v1/sms-templates';
export const UPDATE_SMS_TEMPLATE_V1 = (id) => `/v1/sms-templates/${id}`;
export const DELETE_SMS_TEMPLATE_V1 = (id) => `/v1/sms-templates/${id}`;
