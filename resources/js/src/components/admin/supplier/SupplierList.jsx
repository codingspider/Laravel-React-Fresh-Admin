...
import { LIST_SUPPLIER, DELETE_SUPPLIER } from "../../../routes/apiRoutes";
import {
    SUPPLIER_ADD_PATH,
    SUPPLIER_EDIT_PATH,
    SUPPLIER_VIEW_PATH,
...
export default function SupplierList() {
    ...
    useEffect(() => {
        ...
        document.title = `${app_name} | Supplier Management`;
        fetchData();
    }, [fetchData]);
                ...
                <Menu>
                    ...
                    <MenuList minW="140px" p={1.5}>
                        ...
                        <MenuItem
                            ...
                            borderRadius="md"
                            fontSize="sm"
                            onClick={() => navigate(SUPPLIER_EDIT_PATH(row.original.id), { state: { supplier: row.original } })}
                        >
                            {t("edit")}
                        </MenuItem>
                        <MenuItem
    ...
    return (
        <Box>
            <PageHeader
                ...
                subtitle={t("manage_all_suppliers")}
                breadcrumbs={[
                    { label: t("dashboard"), path: DASHBOARD_PATH },
                    { label: t("suppliers"), isCurrent: true },
                ]}
                action={SUPPLIER_ADD_PATH}
                actionLabel={t("add_supplier")}
            >
                <TableExportButtons data={data} columns={columns} filename="suppliers" />
            </PageHeader>
