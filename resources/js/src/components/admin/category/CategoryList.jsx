                ...
                <Menu>
                    ...
                    <MenuList minW="140px" p={1.5}>
                        <MenuItem
                            ...
                            borderRadius="md"
                            fontSize="sm"
                            onClick={() => navigate(CATEGORY_EDIT.replace(":id", row.original.id), { state: { category: row.original } })}
                        >
                            {t("edit")}
                        </MenuItem>
                        <MenuItem
    ...
    return (
        <Box>
            <PageHeader
                ...
                subtitle={t("manage_all_categories")}
                breadcrumbs={[
            ...
            >
                <TableExportButtons data={data} columns={columns} filename="categories" />
            </PageHeader>
