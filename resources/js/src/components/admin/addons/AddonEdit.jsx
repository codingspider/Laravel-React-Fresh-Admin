...
import { GET_ALL_BRANCHES, UPDATE_ADDON } from "../../../routes/apiRoutes";
...
const AddonEdit = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            const res = await api.put(UPDATE_ADDON(addon.id), data);
            reset();
    ...
    useEffect(() => {
        ...
        document.title = `${app_name} | Addon Update`;
        getBranches();
                    ...
                    <CardHeader bg={colors.bgCard} borderBottom="1px solid" borderColor={colors.borderSubtle} pb={6}>
                        <Flex justify="space-between" align="center">
                            <Box>
                                ...
                                <Text fontSize="sm" color={colors.textSecondary} mt={1}>{t("update_addon_details")}</Text>
                            </Box>
