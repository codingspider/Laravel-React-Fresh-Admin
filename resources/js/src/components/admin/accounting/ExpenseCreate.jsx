...
import { STORE_EXPENSE, LIST_ACCOUNT, POS_SETTINGS } from "../../../routes/apiRoutes";
...
const ExpenseCreate = () => {
    ...
    const { register, handleSubmit, reset } = useForm({
        defaultValues: { expense_date: new Date().toISOString().split("T")[0], status: "pending" },
    });
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const res = await api.post(STORE_EXPENSE, payload);
            reset();
            toast({
