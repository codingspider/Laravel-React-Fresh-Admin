...
import { LIST_ACCOUNT, DELETE_ACCOUNT } from "../../../routes/apiRoutes";
...
export default function AccountList() {
    ...
    }, [pageIndex, globalFilter, pageSize, typeFilter, statusFilter, branchFilter]);
                ...
                <Menu>
                    ...
                    <MenuList minW="140px" p={1.5}>
                        <MenuItem
                            ...
                            borderRadius="md"
                            fontSize="sm"
                            onClick={() => navigate(`/accounting/accounts/edit/${row.original.id}`, { state: { account: row.original } })}
                        >
                            {t("edit")}
                        </MenuItem>
                        <MenuItem
    ...
    return (
        <Box>
            <PageHeader
                ...
                subtitle={t("manage_all_accounts")}
                breadcrumbs={[
                    { label: t("dashboard"), path: "/dashboard" },
                    { label: t("accounts"), isCurrent: true },
                ]}
                action="/accounting/accounts/create"
                actionLabel={t("add_account")}
            >
                <TableExportButtons data={data} columns={columns} filename="accounts" />
            </PageHeader>
