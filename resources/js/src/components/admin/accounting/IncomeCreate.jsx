...
import { STORE_INCOME, POS_SETTINGS } from "../../../routes/apiRoutes";
...
const IncomeCreate = () => {
    ...
    const { register, handleSubmit, reset, watch } = useForm({
        defaultValues: { source: "manual_income", income_date: new Date().toISOString().split("T")[0] },
    });
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const res = await api.post(STORE_INCOME, payload);
            reset();
            toast({
