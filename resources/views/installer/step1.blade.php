    ...
    <div class="container">
        <div class="card">
            ...
            <div class="section">
                ...
                @if($phpVersionOk)
                    <ul class="checks">
                        <li>PHP >= {{ config('installer.required_php_version') }} <span class="status-ok">OK</span></li>
                    </ul>
                @else
                    <ul class="checks">
                        <li>PHP >= {{ config('installer.required_php_version') }} <span class="status-fail">FAIL</span></li>
                    </ul>
                @endif
            </div>
            <div class="section">
                ...
                <ul class="checks">
                    @foreach($extensions as $ext => $ok)
                        <li>{{ $ext }} <span class="status-{{ $ok ? 'ok' : 'fail' }}">{{ $ok ? 'OK' : 'FAIL' }}</span></li>
                    @endforeach
                </ul>
            </div>
