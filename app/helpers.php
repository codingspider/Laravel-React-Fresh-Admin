...
if (!function_exists('generatePaymentRef')) {
...
if (!function_exists('uploadImage')) {
    function uploadImage($file, $folder = 'uploads', $oldFile = null)
    {
        ...
        $allowedMimes = ['jpg', 'jpeg', 'png', 'gif', 'webp', 'svg'];
...
if (!function_exists('payment_types')) {
    ...
    {
        $payment_types = ['cash' => 'Cash', 'card' => 'Card', 'cheque' => 'Check', 'bank_transfer' => 'Bank Transfer', 'bkash' => 'Bkash', 'nagad' => 'Nagad', 'rocket' => 'Rocket', 'usdt' => 'USDT', 'other' => 'Other'];
        return $payment_types;
    }
}

if (!function_exists('dataShowingNumber')) {
